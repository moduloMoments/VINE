...
name: vine-verify
description: >
  VINE Phase 1: Verify — Context-building spike for feature development in established codebases.
  This is the research and discovery phase where Claude and the engineer explore the existing codebase
  together. The engineer brings tribal knowledge, edge cases, and "the weird stuff" that isn't in the
  docs. Claude reads the code, maps the landscape, and together they produce a CONTEXT.md that captures
  what exists, what's broken, and what the docs don't say. Also surfaces README gaps, tech debt, and
  backlog items to incorporate into planning.
  Use this skill whenever starting work on a new feature, investigating a bug in unfamiliar code,
  onboarding to a new area of the codebase, or when someone says "let me show you how this part works."
  Trigger on: "vine:verify", "let's explore this code", "what does this module do", "I need to understand
  this before we build", "context building", "spike on", "research this area", "let's look at the codebase",
  "before we start coding", "map out the landscape", "start a feature", "new feature", "vine verify".
---
